// Creation of Fullpage with JQuery plugin
function fullPage() {
...
//     })
// }
// $('<img src="./assets/img/projects.jpg">'),
// $('<img src="./assets/img/about.jpg">'),
// $('<img src="./assets/img/contact.jpg">'),

// Animation when the page loading
...
$(function() {
    ...
    $(".js-menuBtn").on("click", function() {
        ...
        $(".name, .icons a i").toggleClass("color-white"),
        $("header .icons .js-menuOpen").toggleClass('bg-white-pseudo'),
